...
```java title="KnapsackComplete.java"
...
```java title="MaxProfitUnlimited.java"
...
```java title="MaxProfitCooldown.java"
...
**动态规划**的核心是多练，**先理解状态定义，再写转移方程，最后优化空间**。按这个顺序，没有 DP 题能难倒你。
