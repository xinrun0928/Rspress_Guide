...
**CAP 理论**告诉我们：一致性（Consistency）、可用性（Availability）、分区容错性（Partition Tolerance），三者只能选其二。
...
```java title="src/main/java/TwoPhaseCommit.java"
...
```java title="src/main/java/TCCOrderService.java"
...
```java title="src/main/java/LocalMessageService.java"
...
```java title="src/main/java/SagaOrchestrator.java"
...
```java title="src/main/java/CacheAsideService.java"
...
```java title="src/main/java/CacheUpdateRaceCondition.java"
...
```java title="src/main/java/ReconcileService.java"
