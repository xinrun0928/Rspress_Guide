...
```java title="src/main/java/HashRouter.java"
// 普通哈希取模
...
```java title="src/main/java/ConsistentHash.java"
// 一致性哈希实现
...
```java title="src/main/java/RedisSlotRouter.java"
// Redis Cluster 的槽计算
...
```java title="src/main/java/KetamaLocator.java"
// Ketama 的核心思想
