...
def get_ec2_inventory():
    ...
    for instance in ec2.instances.all():
        ...
        inventory[role]['hosts'].append(instance.public_ip_address or instance.private_ip_address)
        inventory['_meta']['hostvars'][instance.public_ip_address or instance.private_ip_address] = host_data
...
```bash
# 下载 Role
ansible-galaxy role install nginx_ubuntu
